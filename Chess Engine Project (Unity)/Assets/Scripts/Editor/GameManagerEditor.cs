namespace Chess.EditorScripts {
	...
	public class GameManagerEditor : Editor {
		...
		public override void OnInspectorGUI () {
			...
			bool foldout = true;
			DrawSettingsEditor (manager.whiteAISettings, ref foldout, ref aiSettingsEditor);
			DrawSettingsEditor(manager.blackAISettings, ref foldout, ref aiSettingsEditor);
		}
